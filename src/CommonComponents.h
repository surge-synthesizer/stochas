...
class ToggleCpt : public Component
{
    ...
    int mNumItemsOnEachRow; // number of items on each row (possibly excluding the last row)
                            // (calculated)
...
// This is the actual box that contains everything (as opposed to SeqEditDialog which takes up the
// whole client area and is semi-opaque)
